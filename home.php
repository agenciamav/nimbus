	...
	<div id="header_slider" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="item active">
				...
				<img src="img/slides/slide1.png" class="img-responsive">
			...
			<div class="item">
				...
				<img src="img/slides/slide2.jpg" class="img-responsive">
			           ...
			           <img src="img/em-andamento/torres/fundo-andamento2.png" class="img-responsive" >
			            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
			              ...
			              <div class="carousel-caption">
						    <h1>EMPREENDIMENTOS</br>EM ANDAMENTO</br><hr></br>
						      <a class="navbar-brand logo" href="#header" style"background:transparent;">
						        <img src="img/em-andamento\torres\logo-torre.png" alt="Logo" class="img-responsive">
					          </a>
					         </h1></br>
			              ...
			              <div class="carousel-caption">
						    <h1>EMPREENDIMENTOS</br>EM ANDAMENTO</br><hr></br>
						      <a class="navbar-brand logo" href="#header" style"background:transparent;">
						        ...
						        <img src="img/em-andamento\porto\logo-porto.png" alt="Logo" class="img-responsive">
					          </a>
					        </h1></br></br>
						...
						<div class="col-md-9">
							...
							<div id="obras_slider" class="slider">
								...
								<div class="slides">
									...
									<div class="slideItem">
										<a href="#"> <img src="img/obras/slide_1.jpg"> </a>
										<div class="legend">
											<h4>Título slide</h4>
